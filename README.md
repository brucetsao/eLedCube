...
這本書以市面常使用Led字幕機為主要開發標基本概念，不同的是該立體魔術方塊(Led Cube)為N * N個Led 組立而成，主要的原理是透過視覺暫留的原理，從一列的Led發光二極體，到一面的Led發光二極體，最後到整層的Led發光二極體，產生出立體的視覺效果，如同使用N片的Led發光二極體陣列一般，其中的巧思，令人心儀。所以本書要以『Arduino 光立體魔術方塊開發』 來進行產品設計，相信整個研發過程會更加了解。
